...
<html>
    <head>
        <title>Cetak Data Mobil Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <h2>Sistem Informasi Penjualan Mobil </h2>
                        ...
                        <hr>
                        <h3>DATA MOBIL BULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <tr>
                            ...
                            $sql = "SELECT * FROM mobil WHERE month(tgl_buat)='$ambilbln' AND year(tgl_buat)='$ambilthn'";
