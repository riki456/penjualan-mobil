            ...
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="nama" class="form-control" id="inputEmail3" placeholder="Nama Customer" required>
                            </div>
                        </div>
...
if($_POST){
    ...
    //buat sql
      $sql="INSERT INTO customer VALUES ('','$nama','$jenis_kelamin','$t','$alamat','$email','$no_hp')";
      $query=  mysqli_query($koneksi, $sql) or die ("SQL Simpan Customer Error");
      if ($query){
